...
# ---- CUSTOM CSS: प्रोफेशनल + मोबाइल रेस्पॉन्सिव + विजिबल साइडबार टॉगल ----
st.markdown("""
<style>
    ...
    /* ============================================= */
    /*  साइडबार टॉगल (Open/Close) बटन - बहुत विजिबल  */
    /* ============================================= */
    /* यह बटन टॉप-लेफ्ट कोने में दिखता है */
    ...
    /* बटन के अंदर का आइकन (हैमबर्गर / एरो) */
    ...
    /* ============================================= */
    /*  हेडर - मोबाइल के लिए रेस्पॉन्सिव          */
    /* ============================================= */
    .gov-header {
        background: white;
        padding: 0.6rem 1rem;
    ...
    /* ============================================= */
    /*  साइडबार नेविगेशन (रेडियो बटन स्टाइल)       */
    /* ============================================= */
    .stRadio > div {
